...
var imageData = {};
var imageDataKeys = [];
selectedBrands = 'Dixie|Chinet|Hefty';
...
function loadData() {
  get('brand_counts.json', function(data) {
    ...
    brandCounts = [
    {x: "Dixie", value: brandCountsHolder["Dixie"]},
    {x: "Chinet", value: brandCountsHolder["Chinet"]},
    {x: "Hefty", value: brandCountsHolder["Hefty"]}
];
  })    
...
function addWindowEventListeners() {
  ...
  window.addEventListener('hashchange', function(e) {
    ...
    marker.XPos = (((coords.x + 12100)/(4120 + 12100)) * 300) - (marker.Width / 2);
    marker.YPos = (193 - ((coords.y + 12160)/(8272 + 12160)) * 193) - marker.Height;
    ...
    clusterCounts = [
    {x: "Dixie", value: thisClusterData["Dixie"]},
    {x: "Chinet", value: thisClusterData["Chinet"]},
    {x: "Hefty", value: thisClusterData["Hefty"]}
    ]
...
mapSprite.src = "assets/images/Dixie Full Map.png";
